...
const routes = [
  ...
  // Super Admin routes
  {
    ...
    children: [
      ...
      { path: 'games/sk7755', name: 'SK7755Manage', component: () => import('@/views/super/games/SK7755Page.vue'), meta: { title: '平台管理' } },
      { path: 'games/sk7755-bets', name: 'SK7755Bets', component: () => import('@/views/super/games/SK7755BetsPage.vue'), meta: { title: '投注记录' } },
