...
const tabs = [
  ...
  },
  {
    ...
    svg: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 12v7a2 2 0 01-2 2H6a2 2 0 01-2-2v-7"/><path d="M12 17V3M8 7l4-4 4 4"/></svg>'
  },
  {
    path: '/support',
