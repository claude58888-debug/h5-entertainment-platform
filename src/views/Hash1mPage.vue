<template>
  <div class="canada28-page">
    ...
    <div class="page-header">
      ...
      <h1 class="page-title">{{ $t('game.hash1mTitle') }}</h1>
...
// Mock data - HASH period format
const currentPeriod = ref('HASH-1082451')
const nextPeriod = ref('HASH-1082452')
const currentHash = ref('0x3f8a7e21...b2c1')
const resultBalls = ref([4, 7, 2])
const resultSum = computed(() => resultBalls.value.reduce((a, b) => a + b, 0))
const showHistory = ref(false)

let periodCounter = 1082452

const historyResults = [
  { period: 'HASH-1082450', hash: '0xa1c4d09f...8e3a', balls: [9, 1, 5], sum: 15 },
  { period: 'HASH-1082449', hash: '0x7b2e3f64...c7d2', balls: [3, 8, 6], sum: 17 },
  { period: 'HASH-1082448', hash: '0xe5f01a83...4b9e', balls: [0, 4, 9], sum: 13 },
  { period: 'HASH-1082447', hash: '0x2d8c6b41...f0a7', balls: [7, 2, 3], sum: 12 },
  { period: 'HASH-1082446', hash: '0x9f3e7a05...1d6c', balls: [5, 6, 1], sum: 12 }
]

// Countdown - 60 seconds (1 minute per round)
...
onMounted(() => {
  timer = setInterval(() => {
    if (countdown.value > 0) {
      ...
      countdown.value = 60
      periodCounter++
      currentPeriod.value = `HASH-${periodCounter}`
      nextPeriod.value = `HASH-${periodCounter + 1}`
...
// Bet options - same odds as Canada28
